	...
	return (
		<div className="fixed inset-0 z-10">
			...
			<div className="container mx-auto">
				<div className="flex">
					<h1 className="text-2xl flex-1 font-bold tracking-tight">
						Item Details
					</h1>
					<Button
						elementType="button"
					...
					<div className="grid grid-cols-2 pt-8 gap-24 xl:gap-48">
						...
						{/* accordion list */}
							...
							<div className="pb-2 pt-3 px-4 border-b bg-gray-100">
								<div className="font-medium leading-5">Peter Parker{" - "}<span className="text-gray-600 text-sm leading-5">Supervisor</span></div>

								<div className="text-sm text-gray-600 leading-5">July 15, 2021 to February 12, 2023</div>
							</div>
						</div>
					</div>
				: <></>
